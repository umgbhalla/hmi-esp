...
The firmware shows the diagnostic pattern below for two seconds before the
dashboard so color order, orientation, borders, and all ten DMA bands can be
checked directly on glass.

<img src="artifacts/touch349-v2/test-pattern.png" alt="Touch349 RGB565 diagnostic pattern" width="172">
